...
class recommender(object):
    ...
    def __init__(self, data, k=1, metric='pearson', n=5):
        ...
        currently, if data is dictionary the recommender is initialize to it.
    ...
    def showUserTopRatings(self, id, n):
        """show n top ratings for user with id"""
    ...
    def loadMovieLens(self, path=''):
        ...
        for mid, title in lines:
            self.productid2name[mid.strip()] = title.strip() 
        f.close()
    ...
    def computeNearestNeighbor(self, username):
        ...
        distances = [[x, self.fn(self.data[username], self.data[x])] for x in self.data if x != username]
